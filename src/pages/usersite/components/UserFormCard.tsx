...
import { Role, Site, UserCardInfo } from "../../../data/user/user";
...
const UserFormCard = ({
  ...
  const handleGetRoles = async () => {
    ...
    if (initialValues) {
      form.setFieldsValue({
        ...
        enableEvidences:
          initialValues.uploadCardDataWithDataNet &&
          initialValues.uploadCardEvidenceWithDataNet,
        siteIds: initialValues.sites?.map((site) => site.id), // Inicializa siteIds
      });
    }
  };
  ...
  useEffect(() => {
    const loadSites = async () => {
      const sites = await getSites().unwrap();
  ...
  return (
    <Form form={form} onFinish={onSubmit} layout="vertical">
      <div className="flex flex-col">
        ...
        <AnatomyTooltip title={Strings.userSiteTooltip} />
