...
const resources = {
  ...
  es: {
    translation: {
      ...
      registerCiltNameMaxLengthValidation: "El nombre del procedimiento CILT no puede exceder 100 caracteres",
      ...
      registerCiltDescriptionMaxLengthValidation: "La descripción del procedimiento CILT no puede exceder 500 caracteres",
