...
const resources = {
  en: {
    translation: {
      ...
      discardReasonTooltip: "Enter the reason for discarding cards",
      amDiscardReasonCreatedSuccessfully: "Discard reason created successfully",
      amDiscardReasonUpdatedSuccessfully: "Discard reason updated successfully",
      amDiscardReasonCreateError: "Failed to create discard reason",
      amDiscardReasonUpdateError: "Failed to update discard reason",
          discardCard: "Discard Card",
    discardCardModalTitle: "Discard Card",
    discardReason: "Discard Reason",
      selectDiscardReason: "Select Discard Reason",
      additionalReason: "Additional Reason (Optional)",
      additionalReasonPlaceholder: "Enter additional reason if needed",
      cardDiscardedSuccessfully: "Card discarded successfully",
      errorDiscardingCard: "Error discarding card",
      errorLoadingDiscardReasons: "Error loading discard reasons",
      pleaseSelectDiscardReason: "Please select a discard reason",
  ...
  es: {
    translation: {
      ...
      requiredDiscardReason: "Por favor, introduce la razón de descarte.",
      maxCharactersAllowed: "Máximo {0} caracteres permitidos",
      discardReasonTooltip: "Ingresa la razón para descartar las tarjetas",
      ...
      amDiscardReasonUpdateError: "Error al actualizar la razón de descarte",
          discardCard: "Descartar Tarjeta",
    discardCardModalTitle: "Descartar Tarjeta",
    discardReason: "Motivo de Descarte",
      ...
      cardDiscardedSuccessfully: "Tarjeta descartada exitosamente",
      errorDiscardingCard: "Error al descartar la tarjeta",
      errorLoadingDiscardReasons: "Error al cargar las razones de descarte",
